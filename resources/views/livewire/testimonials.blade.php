        ...
        <form wire:submit.prevent="submit" enctype="multipart/form-data">
            ...
            <x-slot name="content">
                ...
                <div class="mt-4">
                    ...
                    <x-jet-input id="position" class="block mt-1 w-full" type="text" wire:model.debounce.800ms="position" />
                ...
                <div class="mt-4">
                    ...
                    <textarea id="text" class="block mt-1 w-full" type="text" rows="3" name="text" wire:model.debounce.800ms="text">
